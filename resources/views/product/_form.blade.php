...
<div class="row form-group">
    ...
    <div class="col-12 col-md-8">
        {!! Form::number('price', null, ['class' => 'form-control', 'min' => 0, 'step' => 500]) !!}
        <small class="form-text text-muted">{!! $errors->first('price', '<p class="text-danger">:message</p>') !!}</small>
    </div>
</div>
<div class="row form-group">
    <div class="col col-md-4">
        {!! Form::label('Stok Produk', null, ['class' => 'form-control-label']) !!}
    </div>
    <div class="col-12 col-md-8">
        {!! Form::number('stock', null, ['class' => 'form-control', 'min' => 0]) !!}
        <small class="form-text text-muted">{!! $errors->first('stock', '<p class="text-danger">:message</p>') !!}</small>
    </div>
</div>
