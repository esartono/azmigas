...
<div class="row form-group">
    <div class="col col-md-4">
            {!! Form::label('Nama Pelanggan', null, ['class' => 'form-control-label']) !!}
    </div>
...
<div class="row form-group">
    <div class="col col-md-4">
            {!! Form::label('E-Mail', null, ['class' => 'form-control-label']) !!}
    </div>
    <div class="col-12 col-md-8">
        {!! Form::text('email', null, ['class' => 'form-control']) !!}
        <small class="form-text text-muted">{!! $errors->first('email', '<p class="text-danger">:message</p>') !!}</small>
    </div>
</div>
<div class="row form-group">
    <div class="col col-md-4">
